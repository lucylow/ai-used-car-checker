...
export default function SettingsAdvancedV3({onBack,onNavigate}){
 const [active,setActive]=useState('Overview');
 return <Screen><ScreenHeader title="Advanced settings" eyebrow="SETTINGS" subtitle="Expose useful controls without turning the app into a control panel." onBack={onBack}/>

<SettingGroup title="Notifications"><SettingToggle title="Inspection reminders" value={true} onChange={()=>{}}/><SettingToggle title="Market updates" value={true} onChange={()=>{}}/></SettingGroup>
<SettingGroup title="Accessibility"><SettingToggle title="Reduced motion" value={false} onChange={()=>{}}/><SettingToggle title="Large text" value={false} onChange={()=>{}}/></SettingGroup>
<SettingGroup title="Privacy"><ActionRow icon="download-outline" title="Export data" subtitle="JSON / PDF options"/><ActionRow icon="trash-outline" title="Delete account" subtitle="Requires confirmation" tone={COLORS.coral}/></SettingGroup>
