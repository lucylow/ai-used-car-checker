...
export const normalizeCarwiseSettings = (value, fallback = { compactMode: false, aiDisclosure: true, motionIntensity: 'standard' }) => { const source = value && typeof value === 'object' && !Array.isArray(value) ? value : {}; const safeFallback = fallback && typeof fallback === 'object' && !Array.isArray(fallback) ? fallback : {}; const motionIntensity = ['gentle', 'standard', 'lively'].includes(source.motionIntensity) ? source.motionIntensity : ['gentle', 'standard', 'lively'].includes(safeFallback.motionIntensity) ? safeFallback.motionIntensity : 'standard'; return { compactMode: Boolean(source.compactMode), aiDisclosure: source.aiDisclosure !== false, motionIntensity }; };
