...
export const getMarketComparisonSummary = (input = {}) => {
  ...
  if (!value.comparableLow || !value.comparableHigh) return 'Add both comparable bounds to estimate where this asking price sits in the market.';
  if (value.comparableLow > value.askingPrice) return 'Below the comparable range; verify condition and history before negotiating.';
