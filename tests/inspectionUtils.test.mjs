...
import { buildInspectionReport, buildPhotoEvidenceHtml, formatPhotoEvidenceLabel, formatRepairPriorityHtml, getLocalSaveLabel, getOperationStatusLabel, getProgressSummaryLabel, getRecoveryGuidance } from '../src/services/reportUtils.js';
